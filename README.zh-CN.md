...
<div align="center">
	<picture>
		<!-- 替换为你的项目截图 -->
		<img width="80%" src="https://via.placeholder.com/1200x560?text=NotEdit+Screenshot" alt="NOTEDIT 截图">
	</picture>
</div>
...
![功能演示](https://via.placeholder.com/900x420?text=Realtime+Collaboration+Demo)
...
![功能演示](https://via.placeholder.com/900x420?text=AI+Assistant+Demo)
...
![功能演示](https://via.placeholder.com/900x420?text=Export+and+Sharing+Demo)
